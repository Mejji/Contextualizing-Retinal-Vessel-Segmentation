...
_DATASETS = Path(os.getenv('THESIS_DATASETS_ROOT', 'C:/Users/rog/THESIS/DATASETS'))
_DRIU     = Path(os.getenv('THESIS_DRIU_DRIVE_ROOT', 'C:/Users/rog/THESIS/DRIU_DRIVE'))
_VGN_CKPT = Path(os.getenv('THESIS_VGN_CKPT_ROOT', 'C:/Users/rog/THESIS/DRIU_DRIVE/VGN'))

#DAU DRIVE paths
_DAU2    = Path(os.getenv('THESIS_DAU2_DRIVE_ROOT', 'C:/Users/rog/THESIS/DAU2_DRIVE'))
_VGN_DAU2_CKPT = Path(os.getenv('THESIS_VGN_DAU2_CKPT_ROOT', 'C:/Users/rog/THESIS/DAU2_DRIVE/VGN'))
